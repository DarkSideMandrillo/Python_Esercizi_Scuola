    ...
    def run(self):
        ...
        while True:
            ...
            if campi[0] == "checkMinLevel":  # [checkMinimumLevel, level]
                ...
                if (
                    result and result[0]
                ):  # prende il risultato della query (riga) e lo converte in un boolean
                    isMin = True  #!! non capisco a cosa serva
                ...
                if (
                    ...
                    isMed = True
                    print(
                        "ATTENZIONE: pericolo imminente! Il livello è fuori dal 30% al 70% di guardia"
                    )
...
def main():
    ...
    while True:
        ...
        time.sleep(
            15
        )  # attende 15 sec prima di mandare un nuovo thread #!! errore, non deve aspettare la conn
