...
def main():
    ...
    queries = {  #!! non sono query. la data non si aggiorna
        "1": f"checkMinLevel|1.22|{data}|3",  #!! il min med e max non lo può sapere il client
        "2": f"checkMedLevel|3.4|{data}|5",
        "3": f"checkMaxLevel|3.71|{data}|1",
    }
    #!! dove chiedi o usi ID stazione?
    ...
    while True:
        ...
        if choice in queries:
            ...
            messageServer = s.recv(BUFFER_SIZE)  #!! non riceve
